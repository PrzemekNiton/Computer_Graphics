...
public class Lab7 extends JPanel implements GLEventListener {
	...
	private void drawCurrentShape(GL2 gl2) {
		switch (currentObjectNum) {
			...
			case 6:
				...
				break;
			case 7:
				// Przekształca kontekst do środka i rysuje piramidę
				gl2.glRotated(-90, 1, 0, 0);
				gl2.glTranslated(0, 0, -0.4);
				TexturedShapes.uvPiramida(gl2);
				break;
		}
	}
	...
	private Texture textureFromPainting() {
		Texture texture;
		BufferedImage img = paintPanel.copyOSC(); // dodawania obrazka do panelu malowania
		...
		GL2 gl2 = context.getGL().getGL2(); // Pobiera gl2 w bieżącym kontekście
